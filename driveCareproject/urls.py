...
urlpatterns = [
    ...
    path('quickbooking',views.quickbooking),
    path('checklogin',views.checklogin),
    path('logout',views.logout),
    path('accountbookking',views.account_booking),
    path('accountdashboard',views.account_dashboard),
    path('accountprofile',views.account_profile),
